...
import { Customer, ICustomer, ITransaction, IUser, Transaction, User } from '@anhzf-soekaer/shared/models';
import { CollectionReference, Firestore, QueryDocumentSnapshot, doc } from 'firebase/firestore';
